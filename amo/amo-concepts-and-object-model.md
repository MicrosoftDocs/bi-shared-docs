...
# AMO Concepts and Object Model
 ...
 With AMO you cannot query your data. To query your data, use [Developing with ADOMD.NET](developing-with-adomd-net.md).  
  

  
##  AMO in the Analysis Services architecture  
 By design, AMO is only intended for object management and not for querying data. If the user needs to query data from a client application, the client application should use [Developing with ADOMD.NET](developing-with-adomd-net.md).  
...
##  AMO architecture  
 ...
 ![AMO Classes High Level View](media/amo-highlevelview-majorobjectshighlighted.gif "AMO Classes High Level View")  
 ...
 ![AMO Major Objects highlighted](media/amo-majorobjects.gif "AMO Major Objects highlighted")  
  
 ![AMO Major Objects highlighted (2)](media/amo-majorobjects-02.gif "AMO Major Objects highlighted (2)")  
