...
# Path Element (ASSL)
  ...
  Contains the path, as provided by an instance of [!INCLUDE[ssRSnoversion](../../../includes/ssrsnoversion-md.md)], of a report used by the [ReportAction](data-type/reportaction-data-type-assl.md) element.  
