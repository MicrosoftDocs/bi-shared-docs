...
|--------------------|----------------|  
|[Server](../../../analysis-services/scripting/objects/server-element-assl.md)|The value must follow the rules for  Windows computer names. (IP addresses are not valid.)|  
