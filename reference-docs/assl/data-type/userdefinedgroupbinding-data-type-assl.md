...
## Remarks  
 **UserDefinedGroupBinding** is automatically treated as an [AttributeBinding](data-type/attributebinding-data-type-assl.md), whose [Type](properties/type-element-binding-assl.md) element is set to *All*.  
