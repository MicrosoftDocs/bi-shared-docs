...
# PushedDataSource Data Type (ASSL)
  ...
  Defines a primitive data type that represents a data source (such as a Microsoft SQL Server Integration Services package) used for "pushing" data into a [Cube](../../../analysis-services/scripting/objects/cube-element-assl.md) element.  
