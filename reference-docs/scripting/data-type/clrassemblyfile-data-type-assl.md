...
# ClrAssemblyFile Data Type (ASSL)
  ...
  Defines a primitive data type that represents one of the files that compose a Microsoft Microsoft .NET Framework  **Assembly** ([ClrAssembly](../../../analysis-services/scripting/data-type/clrassembly-data-type-assl.md) element).  
