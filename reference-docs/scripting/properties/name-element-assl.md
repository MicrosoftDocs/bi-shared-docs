...
|--------------------|------------------------|  
|[Server](../../../analysis-services/scripting/objects/server-element-assl.md)|The name must follow the rules for Microsoft Windows computer names. IP addresses are not valid.|  
