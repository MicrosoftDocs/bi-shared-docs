...
# KeyErrorLimitAction Element (ASSL)
  ...
  Specifies the action Microsoft SQL Server Analysis Services takes when the key error count that is specified in the [KeyErrorLimit](keyerrorlimit-element-assl.md) element is reached.  
