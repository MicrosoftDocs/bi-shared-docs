...
# AggregationID Element (ASSL)
  ...
  Identifies the aggregation definition from the [AggregationDesign](../../assl/objects/aggregationdesign-element-assl.md) element used to create the aggregation instance.  
