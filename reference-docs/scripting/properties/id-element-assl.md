...
## Remarks  
 Every major object in Microsoft SQL Server Analysis Services has an **ID** element as a property. The value of an **ID** element has the following restrictions:  
...
|--------------------|----------------|  
|[Server](../../../analysis-services/scripting/objects/server-element-assl.md)|The value must follow the rules for Microsoft Windows computer names. (IP addresses are not valid.)|  
