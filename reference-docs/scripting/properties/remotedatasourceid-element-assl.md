...
# RemoteDatasourceID Element (ASSL)
  ...
  Specifies the identifier (ID) of the OLAP data source that points to the instance of Microsoft SQL Server Analysis Services that stores the remote partition.  
