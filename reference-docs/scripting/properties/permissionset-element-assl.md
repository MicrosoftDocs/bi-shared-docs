...
|*Unrestricted*|Unrestricted allows assemblies unrestricted access to resources, both within and outside Microsoft SQL Server. Code executing from within an *Unrestricted* assembly can call unmanaged code.|  
