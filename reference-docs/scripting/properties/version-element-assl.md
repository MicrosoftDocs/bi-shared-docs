...
# Version Element (ASSL)
  ...
  Contains the read-only version number of the instance of Microsoft SQL Server Analysis Services represented by the [Server](../objects/server-element-assl.md) element.  
