...
|------------------|-------------|  
|Parent elements|[Cube](cube-element-assl.md), [Dimension](dimension-element-assl.md), [MeasureGroup](measuregroup-element-assl.md), [MiningStructure](miningstructure-element-assl.md), [Partition](partition-element-assl.md)|  
