...
# Cube Element (ASSL)
  ...
  Defines a regular, virtual, or linked cube in a Microsoft SQL Server Analysis Services [Database](../../../analysis-services/scripting/objects/database-element-assl.md) element.  
