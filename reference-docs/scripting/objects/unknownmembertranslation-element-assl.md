...
# UnknownMemberTranslation Element (ASSL)
  ...
  Contains a translation for the caption of the [UnknownMember](../properties/unknownmember-element-assl.md) element for a [Dimension](dimension-element-assl.md) element.  
