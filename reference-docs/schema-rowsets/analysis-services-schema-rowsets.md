...
|[DISCOVER_TRACE_COLUMNS](https://msdn.microsoft.com/library/ee301342)|Contains the DISCOVER_TRACE_COLUMNS schema rowset.|  
|[DISCOVER_TRACE_DEFINITION_PROVIDERINFO](https://msdn.microsoft.com/library/ee301827)|Contains the DISCOVER_TRACE_COLUMNS schema rowset.|  
