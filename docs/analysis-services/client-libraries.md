...
|Download  | Version  |
|---------|---------|
|[MSOLAP (amd64)](https://go.microsoft.com/fwlink/?linkid=829576)    |    16.0.87.16        |
|[MSOLAP (x86)](https://go.microsoft.com/fwlink/?linkid=829575)     |     16.0.87.16           |
|[AMO](https://go.microsoft.com/fwlink/?linkid=829578)     |   19.65.4.0         |
|[ADOMD](https://go.microsoft.com/fwlink/?linkid=829577)     |    19.65.4.0           |
...
|Package  | Version  |
|---------|---------|
|[AMO](https://www.nuget.org/packages/Microsoft.AnalysisServices.retail.amd64/)    |    19.65.4.0     |
|[ADOMD](https://www.nuget.org/packages/Microsoft.AnalysisServices.AdomdClient.retail.amd64/)     |   19.65.4.0      |

#### AMO and ADOMD .Net Core

|Package  | Version  |
|---------|---------|
|[AMO .Net Core](https://www.nuget.org/packages/Microsoft.AnalysisServices.NetCore.retail.amd64)    |    19.65.4.0      |
|[ADOMD .Net Core](https://www.nuget.org/packages/Microsoft.AnalysisServices.AdomdClient.NetCore.retail.amd64)     |   19.65.4.0        |
...
Beginning with version 16.0.87.16, MSOLAP setup no longer installs the native Azure Active Directory Authentication Library for .NET (ADAL.NET) client. Authentication for cloud-based Analysis Services is based only on the managed Microsoft Authentication Library for .NET (MSAL.NET) client. If using the MSAL client isn't possible in your environment, contact Microsoft Customer Support to determine a workaround.
