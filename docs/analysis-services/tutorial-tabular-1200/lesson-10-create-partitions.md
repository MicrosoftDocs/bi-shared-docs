...
description: Learn how to create partitions for a tabular model project.
ms.date: 05/07/2019
ms.prod: sql
...
## Prerequisites  
This topic is part of a tabular modeling tutorial, which should be completed in order. Before performing the tasks in this lesson, you should have completed the previous lesson: [Lesson 9: Create Hierarchies](lesson-9-create-hierarchies.md).  
