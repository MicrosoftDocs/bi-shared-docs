...
|Binary|String|Unstructured binary data, for example images. Columns with this data type have limited functionality in DAX. The effective maximum size of a binary data value is subject to a 67108864 byte limit. |
