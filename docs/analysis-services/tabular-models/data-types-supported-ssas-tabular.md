...
|Binary|N/A|Unstructured binary data, for example images. Columns with this data type are unavailable in DAX. The effective maximum size of a binary data value is subject to a 67108864 byte limit. |
