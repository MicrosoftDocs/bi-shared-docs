...
## Related content 
 ...
 [Using Service SIDs to grant permissions to services in SQL Server 2017](https://learn.microsoft.com/sql/relational-databases/security/using-service-sids-to-grant-permissions-to-services-in-sql-server?view=sql-server-2017)   
