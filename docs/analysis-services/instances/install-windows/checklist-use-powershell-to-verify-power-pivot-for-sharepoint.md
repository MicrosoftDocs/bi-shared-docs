...
##  <a name="bkmk_more_resources"></a> More Resources  
 ...
 [PowerShell to check services, IIS sites and Application Pool status in SharePoint](../../../../../OfficeDocs-SharePoint-PowerShell/sharepoint/sharepoint-ps/sharepoint-server/Get-SPServiceApplicationPool.md).  
