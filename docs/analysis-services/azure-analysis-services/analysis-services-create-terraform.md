...
1. Create a file named `main.tf` and insert the following code:
    ...
    [!code-terraform[master](/azure/terraform_samples/quickstart/101-analysis-services-create/main.tf)]

1. Create a file named `outputs.tf` and insert the following code:

    [!code-terraform[master](/azure/terraform_samples/quickstart/101-analysis-services-create/outputs.tf)]

1. Create a file named `providers.tf` and insert the following code:

    [!code-terraform[master](/azure/terraform_samples/quickstart/101-analysis-services-create/providers.tf)]

1. Create a file named `variables.tf` and insert the following code:

    [!code-terraform[master](/azure/terraform_samples/quickstart/101-analysis-services-create/variables.tf)]

## Initialize Terraform

[!INCLUDE [terraform-init.md](/azure/azure-dev-docs-pr/articles/terraform/includes/terraform-init)]

## Create a Terraform execution plan

[!INCLUDE [terraform-plan.md](/azure/azure-dev-docs-pr/articles/terraform/includes/terraform-plan)]

## Apply a Terraform execution plan

[!INCLUDE [terraform-apply-plan.md](/azure/azure-dev-docs-pr/articles/terraform/includes/terraform-apply-plan)]
...
[!INCLUDE [terraform-plan-destroy.md](/azure/azure-dev-docs-pr/articles/terraform/includes/terraform-plan-destroy)]
