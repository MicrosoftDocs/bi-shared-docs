...
This quickstart describes how to create an Analysis Services server resource in your Azure subscription by using [Bicep](/azure-docs-pr/azure-docs-pr/articles/azure-resource-manager/bicep/overview.md).
