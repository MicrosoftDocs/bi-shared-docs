...
2. In **Analysis Services**, fill in the required fields, and then press **Create**.
   ...
   * **Resource group**: Create a new resource group or select one you already have. Resource groups are designed to help you manage a collection of Azure resources. To learn more, see [resource groups](/azure/azure-resource-manager/management/overview).
   ...
   * **Backup Storage setting**: Optional. If you already have a [storage account](/azure/storage/common/storage-introduction), you can specify it as the default for model database backup. You can also specify [backup and restore](analysis-services-backup.md) settings later.
