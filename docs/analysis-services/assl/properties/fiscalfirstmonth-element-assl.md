...
description: Learn about the FiscalFirstMonth property element in the Analysis Services Scripting Language (ASSL) schema.
ms.date: 7/25/2018
ms.prod: sql
ms.custom: assl
ms.reviewer: owend
...
# FiscalFirstMonth Element (ASSL)
  ...
  Defines the first month of the fiscal period for a [TimeBinding](../data-type/timebinding-data-type-assl.md) element.  
