...
|Tabular in SQL Server 2016 and later|Relational modeling constructs (model, tables, columns), articulated in tabular metadata definitions in [Tabular Model Scripting Language (TMSL)](/analysis-services/tmsl/tabular-model-scripting-language-tmsl-reference) and [Tabular Object Model (TOM)](tom/introduction-to-the-tabular-object-model-tom-in-analysis-services-amo.md) code.|SQL Server 2016</br> SQL Server 2014</br> SQL Server 2019</br> SQL Server 2022| 1200 </br> 1400 </br> 1500</br> 1600|
