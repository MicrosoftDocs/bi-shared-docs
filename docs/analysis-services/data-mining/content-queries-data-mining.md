...
###  <a name="bkmk_DecTree"></a> Example 2: Content Query on a Decision Trees Model  
 ...
 In your prediction query, you add the prediction function [PredictNodeId &#40;DMX&#41;](/sql/dmx/predictnodeid-dmx.md), to get the ID of the related node, as shown in the following example:  
...
## See Also  
 [Understanding the DMX Select Statement](/sql/dmx/understanding-the-dmx-select-statement.md)   
