...
## Build a Profit Chart  
 ...
 If you don't have the sample model, you can create it using the [Basic Data Mining Tutorial](https://msdn.microsoft.com/library/6602edb6-d160-43fb-83c8-9df5dddfeb9c).  
