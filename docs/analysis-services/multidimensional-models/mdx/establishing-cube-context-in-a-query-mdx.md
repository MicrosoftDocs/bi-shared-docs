...
```  
 ...
 For more information about the FROM clause in the MDX SELECT statement, see [SELECT Statement &#40;MDX&#41;](/sql/mdx/mdx-data-manipulation-select.md).  
...
## Refining the Context  
 ...
 You can use the MDX [LookupCube](/sql/mdx/lookupcube-mdx.md) function to retrieve data from cubes outside the cube context. Additionally, functions such as the [Filter](/sql/mdx/filter-mdx.md) function, are available that allow temporary restriction of the context while evaluating the query.  
