...
-   [CALCULATE](/sql/mdx/mdx-scripting-calculate.md)  
  
-   [FREEZE](/sql/mdx/mdx-scripting-freeze.md)  
  
-   [SCOPE](/sql/mdx/mdx-scripting-scope.md)  
  
 For more information on MDX scripting statements, see [MDX Scripting Statements &#40;MDX&#41;](/sql/mdx/mdx-scripting-statements-mdx.md).  
  
 [CREATE MEMBER](/sql/mdx/mdx-data-definition-create-member.md)  
 ...
 [CREATE SET](/sql/mdx/mdx-data-definition-create-set.md)  
 ...
 Conditional statements add conditional logic to MDX scripts. This category includes the [CASE](/sql/mdx/case-statement-mdx.md) and [IF](/sql/mdx/mdx-scripting-if.md) statements.  
