...
-   [Configure SQL Server Agent](/sql/ssms/agent/configure-sql-server-agent.md)  
  
-   [SQL Server Agent Components](/sql/ssms/agent/sql-server-agent.md) suggests alternative fixed server roles if granting **sysadmin** permissions is not possible.  
...
## See Also  
 [SQL Server Agent Components](/sql/ssms/agent/sql-server-agent.md)   
