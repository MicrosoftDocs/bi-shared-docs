...
>   
>  Slicer cannot be defined on a dimesnion that has Many-To-Many relationship or unmaterialized referenced relationship with the partition measure group. The slicer validation will fail with error "The slice specified for the ... attribute is incorrect". That is because an unmaterialized relationship has no valid dimension attribute data ID range data for evaluation of slicer validation.   
## See Also  
