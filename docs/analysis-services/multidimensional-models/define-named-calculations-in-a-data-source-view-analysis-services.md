...
description: Use a named calculation to extend the relational schema of tables or views in a data source view without changing the underlying data source.
ms.date: 05/02/2018
ms.prod: sql
